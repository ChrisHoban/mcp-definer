...
2. **Target-API credentials & secrets** — how a generated MCP authenticates to *its* upstream API, via **credential bindings** that reference secrets stored in a vault/keychain (never in Manifests).
